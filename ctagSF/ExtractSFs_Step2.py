...
parser.add_argument('--AdaptiveIteration', action='store_true', help='Order the iterative fit from purest region to impure')
...
#             print "SFl = ",SFs_result[2], " +- ", sqrt(result.hess_inv[2][2])
    ...
    cSFb = ROOT.TCanvas("cSFb","cSFb",1200,1200)
    ...
    latex_cms.DrawLatexNDC(0.15,0.85,"Wc/Wb/DYl selection")
